...
// Grundlage für den Code: Vorlage#10 + Praktikum 
interface todolisteneintrag {
    todoText: string;
    todosChecked: boolean;
}
var todoliste: todolisteneintrag [] = [
    {
        todoText: "Lorem",
        todosChecked: true
    },
...
function updateCounter(): void {
    ...
    doneDOMElement.innerHTML = counterChecked + "done"; 
    offenDOMElement.innerHTML = stillToDo + "still to do";
